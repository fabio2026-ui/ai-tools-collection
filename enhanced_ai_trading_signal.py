        ...
        <body>
            <div class="container">
                <header>
                    <h1>🚀 AI交易信号系统 - 增强版</h1>
                    <p class="subtitle">实时交易信号 • 技术分析 • 智能决策</p>
                </header>
                ...
                <div class="dashboard">
                    ...
                    <div class="card">
                        ...
                        <button class="refresh-btn" onclick="loadMarketData()">刷新数据</button>
                    </div>
                    
                    <!-- 交易信号卡片 -->
                    <div class="card">
                        <h2>🔔 最新交易信号</h2>
                        <div class="signal-grid" id="signalsList">
                            <!-- 交易信号将通过JavaScript动态加载 -->
                        </div>
